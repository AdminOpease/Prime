    ...
    <section className="bg-[var(--color-bg)] py-20 sm:py-24">
      <Container>
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <Link
            href="/services"
            className="hidden text-sm font-semibold text-[var(--color-accent)] hover:underline sm:inline-flex"
          >
            See all services →
          </Link>
        </div>
          ...
          {servicePlaceholders.map((service, i) => (
            ...
            >
              <Link
                ...
                className="group flex h-full flex-col justify-between gap-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] p-6 transition-all hover:border-[var(--color-accent)] hover:shadow-md"
              >
                <div>
